...
public class Observations {
	...
	// Used to add random outliers to subject transitions
	// The array with new_values (indexes) replaces the original ones
	public void SetObservationsMatrix(int transition, int subject, int[] new_values) {
		System.out.println("Before:" + Arrays.toString(this.usefulObservations[transition][subject]));
		this.usefulObservations[transition][subject] = new_values;
		System.out.println("After:" + Arrays.toString(this.usefulObservations[transition][subject]));
	}
